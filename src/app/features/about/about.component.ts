    ...
    <div class="content-wrapper">
      ...
      <section class="container section-margin who-we-are">
        <div class="text-content">
          <h2 class="underline-title">{{ "ABOUT.WHO_WE_ARE" | translate }}</h2>
          <p>
            {{ "ABOUT.WHO_WE_ARE_DESC" | translate }}
          </p>
        </div>
      </section>
      ...
      <section class="container mv-grid">
        <div class="info-card">
          ...
          <h3>{{ "ABOUT.MISSION" | translate }}</h3>
          <p>
            {{ "ABOUT.MISSION_DESC" | translate }}
          </p>
        </div>
        <div class="info-card">
      ...
      <section class="container section-margin">
        <h2 class="underline-title">{{ "ABOUT.WHY_BENHA_ON" | translate }}</h2>
        <div class="features-grid">
          <div class="feature-box">
            <h4>{{ "ABOUT.FEATURE_1" | translate }}</h4>
            <p>{{ "ABOUT.FEATURE_1_DESC" | translate }}</p>
          </div>
          <div class="feature-box">
            <h4>{{ "ABOUT.FEATURE_2" | translate }}</h4>
            <p>{{ "ABOUT.FEATURE_2_DESC" | translate }}</p>
          </div>
          <div class="feature-box">
            <h4>{{ "ABOUT.FEATURE_3" | translate }}</h4>
            <p>{{ "ABOUT.FEATURE_3_DESC" | translate }}</p>
          </div>
        </div>
      </section>
      ...
      <!-- Our Team -->
      <section class="container section-margin">
        <h2 class="team-header">{{ "ABOUT.TEAM" | translate }}</h2>
        <div class="team-grid">
...
export class AboutComponent {
  teamMembers: TeamMember[] = [
    ...
    { name: "Aya Khaled", role: "Graphic Designer", photo: "assets/aya.jpg" },
    {
      name: "Rawan Hamdy",
      role: "Graphic Designer",
      photo: "assets/rawan.jpg",
    },
    { name: "Nora Yehia", role: "Graphic Designer", photo: "assets/nora.jpg" },
    {
      name: "Hager Geber",
      role: "Graphic Designer",
      photo: "assets/hager.jpg",
    },
    {
      name: "Mayan Ayman",
      role: "Graphic Designer",
      photo: "assets/mayan.jpg",
    },
    {
      name: "Samia Samir",
      role: "Graphic Designer",
      photo: "assets/samia.jpg",
    },
    {
      name: "Menna Ahmed",
      role: "Graphic Designer",
      photo: "assets/menna.jpg",
    },
    {
      name: "Alaa El-Sayed",
      role: "Graphic Designer",
